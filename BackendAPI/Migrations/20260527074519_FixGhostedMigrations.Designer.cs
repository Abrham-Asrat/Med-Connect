...
namespace BackendAPI.Migrations
{
    ...
    [Migration("20260527074519_FixGhostedMigrations")]
    partial class FixGhostedMigrations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackendAPI.Source.Models.Entities.DoctorTimeOff", b =>
                {
            ...
            modelBuilder.Entity("BackendAPI.Source.Models.Entities.PrescriptionModel", b =>
                {
            ...
            modelBuilder.Entity("BackendAPI.Source.Models.Entities.SystemSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BackendAPI.Source.Models.Entities.UserModel", b =>
                {
                    ...
                    b.Property<bool>("PrefAppointmentReminders")
                        .HasColumnType("bit");

                    b.Property<bool>("PrefMarketingEmails")
                        .HasColumnType("bit");

                    b.Property<bool>("PrefNewMessages")
                        .HasColumnType("bit");

                    b.Property<bool>("PrefPaymentReceipts")
                        .HasColumnType("bit");

                    b.Property<bool>("PrefReviewRequests")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("BackendAPI.Source.Models.Entities.BlogComment", b =>
                {
                    ...
                    b.HasOne("BackendAPI.Source.Models.Entities.BlogComment", "ParentComment")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("BackendAPI.Source.Models.Entities.Conversation", b =>
                {
                    b.HasOne("BackendAPI.Source.Models.Entities.Appointment", "Appointment")
                        .WithMany()
            ...
            modelBuilder.Entity("BackendAPI.Source.Models.Entities.PrescriptionModel", b =>
                {
                    ...
                    b.HasOne("BackendAPI.Source.Models.Entities.Message", "Message")
                        .WithOne("PrescriptionDetails")
                        .HasForeignKey("BackendAPI.Source.Models.Entities.PrescriptionModel", "MessageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
