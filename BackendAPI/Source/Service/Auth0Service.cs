...
//                 {
//                     // make sure authority is clean and valid before using it
//                 var baseUrl = appConfig.Auth0Authority?.Trim().TrimEnd('/');
//                 if (string.IsNullOrWhiteSpace(baseUrl) || !Uri.IsWellFormedUriString(baseUrl, UriKind.Absolute))
//                 {
//                     logger.LogError("Invalid Auth0Authority configured: '{Auth0Authority}'", appConfig.Auth0Authority);
//                     throw new InvalidOperationException("Auth0 authority URL is not configured correctly.");
//                 }
